export default function PopupShare({ setIsOpen }) {
    return (
        <div className="p-5 space-y-7 w-3/4 flex flex-col items-center rounded-xl bg-white">
            ...
            <div className="grid grid-cols-3 w-full gap-5">
                <div className="col-span-1 flex flex-col items-center justify-center">
                    <div className="rounded-full w-15 h-15 bg-[#0077B5] flex items-center justify-center text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="size-6">
                ...
                <div className="col-span-1 flex flex-col items-center justify-center">
                    <div className="rounded-full w-15 h-15 bg-[#3B5998] flex items-center justify-center text-white">
                ...
                <div className="col-span-1 flex flex-col items-center justify-center">
                    <div className="rounded-full w-15 h-15 bg-[#25D366] flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="size-6">
                ...
                <div className="col-span-1 flex flex-col items-center justify-center">
                    <div className="rounded-full w-15 h-15 bg-[#EBEEF2] flex items-center justify-center">
            ...
            <div className="border border-[#0056D2] rounded-lg flex overflow-hidden">
                ...
                <div className="bg-[#0056D2] p-2 font-semibold text-white">Salin</div>
            </div>
        </div>
    )
}