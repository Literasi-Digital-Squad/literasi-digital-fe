...
export default function ListPertanyaan({ level, setIdDelete, setIsDelete }) {
    const [listPertanyaan, setListPertanyaan] = useState([
        { gambar: "https://media.istockphoto.com/id/1386740242/vector/vector-bubbles-with-question-mark-question-icons-isolated-on-white.jpg?s=612x612&w=0&k=20&c=evjrckVKb_RVRcN5qV1Tz1pkSu3FvHKCGtynu8btxhA=", deskripsi: "Berdasarkan email di atas, apa yang menjadi tanda bahwa email tersebut merupakan scam atau penipuan?" },
        { gambar: "https://media.istockphoto.com/id/1386740242/vector/vector-bubbles-with-question-mark-question-icons-isolated-on-white.jpg?s=612x612&w=0&k=20&c=evjrckVKb_RVRcN5qV1Tz1pkSu3FvHKCGtynu8btxhA=", deskripsi: "Berdasarkan email di atas, apa yang menjadi tanda bahwa email tersebut merupakan scam atau penipuan?" },
        { gambar: "https://media.istockphoto.com/id/1386740242/vector/vector-bubbles-with-question-mark-question-icons-isolated-on-white.jpg?s=612x612&w=0&k=20&c=evjrckVKb_RVRcN5qV1Tz1pkSu3FvHKCGtynu8btxhA=", deskripsi: "Berdasarkan email di atas, apa yang menjadi tanda bahwa email tersebut merupakan scam atau penipuan?" },
        { gambar: "https://media.istockphoto.com/id/1386740242/vector/vector-bubbles-with-question-mark-question-icons-isolated-on-white.jpg?s=612x612&w=0&k=20&c=evjrckVKb_RVRcN5qV1Tz1pkSu3FvHKCGtynu8btxhA=", deskripsi: "Berdasarkan email di atas, apa yang menjadi tanda bahwa email tersebut merupakan scam atau penipuan?" },
    ]);
                        ...
                        <tbody>
                            {listPertanyaan.map((pertanyaan, index) => (
                                <tr key={index} className="hover:bg-gray-100 odd:bg-gray-100 even:bg-white items-center">
                                    <td className="px-4 py-3"><img src={pertanyaan.gambar} alt="" className="w-32" /></td>
                                    <td className="px-4 py-3">{pertanyaan.deskripsi}</td>
                                    <td className="px-4 py-3">
                                        <div className="flex justify-center gap-2">
                                            <button type="button" className="flex items-center bg-[#FFB332] text-white p-3 rounded-lg cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                                </svg>
                                            </button>
                                            <button type="button" className="flex items-center bg-[#D32F2F] text-white p-3 rounded-lg cursor-pointer" onClick={() => setIsDelete(true)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
